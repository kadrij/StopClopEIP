...
import com.eip.stopclopeip.Utils.ViewPagerAdapter;
...
public class StatFragment extends Fragment {
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        StatPressionFragment statPressionFragment = new StatPressionFragment();
        StatMoneyFragment statMoneyFragment = new StatMoneyFragment();

        statPressionFragment.setArguments(bundle);
        statMoneyFragment.setArguments(bundle);

        adapter.AddFragment(statPressionFragment, "Pressions");
        adapter.AddFragment(statMoneyFragment, "Economies");
