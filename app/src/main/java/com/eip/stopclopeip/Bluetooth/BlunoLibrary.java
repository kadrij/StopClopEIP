package com.eip.stopclopeip.Bluetooth;
...
//	byte[] mBaudrateBuffer={0x32,0x00,(byte) (mBaudrate & 0xFF),(byte) ((mBaudrate>>8) & 0xFF),(byte) ((mBaudrate>>16) & 0xFF),0x00};;
    ...
    public void onCreateProcess()
    {
    	if(!initiate())
		{
			Toast.makeText(mainContext, "La bluetooth n'est pas supporté par cet appareil",
		...
		.setTitle("Recherche de l'objet").setAdapter(mLeDeviceListAdapter, new DialogInterface.OnClickListener() {
